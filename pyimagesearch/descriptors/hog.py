...
class HOG:
	def __init__(self, orientations=12, pixelsPerCell=(4, 4), cellsPerBlock=(2, 2), normalise=True):
	...
	def describe(self, image):
		...
		# otherwise comput Histogram of Oriented Gradients features for scikit-image >= 0.13
			...
			hist = feature.hog(image, orientations=self.orientations, pixels_per_cell=self.pixelsPerCell,
				cells_per_block = self.cellsPerBlock, transform_sqrt = self.normalise, block_norm="L1")
